...
#include "../utilities/pair.hpp"  // path to ft::pair.
...
#define TIME_FAC 6 // the ft::set methods can be slower up to std::set methods * TIME_FAC (MAX 20)
...
int main()
{
    ...
    std::cout << REDD << "________________________________________________________________________________________________________" << std::endl;
    std::cout << REDD << "**** The test is taking so much time to test the all cases and the time complexity of each method ****" << std::endl;
    std::cout << REDD << "--------------------------------------------------------------------------------------------------------" << RESET << std::endl;
