...
private:
	typedef typename allocator_type::template rebind<avl_node<value_type> >::other	avl_node_allocator;
	typedef avl_tree<value_type, key_compare,  avl_node_allocator> avl_tree;
public:
	typedef ft::map_iterator<value_type, avl_node<value_type>, avl_tree>    iterator;
	typedef ft::map_iterator<value_type const, avl_node<value_type> const, avl_tree const>  const_iterator;
